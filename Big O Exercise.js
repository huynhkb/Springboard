...
function vowelCount(str) {
  ...
  6. What’s the time complexity of the .forEach array method?         O(n) , depends on what the callback does
  7. What’s the time complexity of the .sort array method?         O(nlogn)
  8. What’s the time complexity of the .unshift array method?         O(n)
  9. What’s the time complexity of the .push array method?         O(1)
  10. What’s the time complexity of the .splice array method?         O(n), can be O(1) if the end, but we can't assume that.
